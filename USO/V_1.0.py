...
SOUNDS = {"a":simplegui.load_sound("https://cdn.discordapp.com/attachments/507330999852466238/844797156263198730/a.mp3")
         ...
         ,"H_A_D":simplegui.load_sound("https://cdn.discordapp.com/attachments/507330999852466238/855197729142341653/Undertale_Ost_087_-_Hopes_and_Dreams.mp3")
         ,"Slow_H_A_D":simplegui.load_sound("https://cdn.discordapp.com/attachments/507330999852466238/855199609789612062/Slow_Undertale_Ost_087_-_Hopes_and_Dreams.mp3")
...
IMG = {"BKG":simplegui.load_image("https://i.imgur.com/EQTl8Re.png")
    #Beat colors
      ...
      ,"SONG_WIN":simplegui.load_image("https://cdn.discordapp.com/attachments/507330999852466238/855123661941506048/Song_Win.png")
      ,"USO":simplegui.load_image("https://cdn.discordapp.com/attachments/507330999852466238/855203967013093426/USO.png")
      }
...
#44, 106, 168, 230, 292
#171 bpm
h_a_d_soundtrack = [(240/190-0.6, 44, 67, "rest"),
                   (120/171, 44, ord('F'), 0),(120/171, 168, ord('J'), 0),(240/171, 106, ord('F'), 0),
                   (120/171, 292, ord('J'), 0),(120/171, 168, ord('F'), 0),(240/171, 230, ord('J'), 0),
                   (120/171, 44, ord('H'), 0),(120/171, 106, ord('J'), 0),(180/171, 230, ord('O'), 0), (60/171, 292, ord('P'), 0),
                   (120/171, 230, ord('O'), 0),(120/171, 168, ord('J'), 0),(240/171, 106, ord('J'), 0), #Measure 8
                   (120/171, 292, ord('J'), 0),(120/171, 168, ord('F'), 0),(240/171, 230, ord('J'), 0),
                   (120/171, 44, ord('F'), 0),(120/171, 168, ord('J'), 0),(240/171, 106, ord('F'), 0),
                   (120/171, 44, ord('G'), 0),(120/171, 106, ord('F'), 0),(180/171, 230, ord('W'), 0), (60/171, 292, ord('Q'), 0),
                   (120/171, 230, ord('W'), 0),(120/171, 168, ord('E'), 0),(240/171, 106, ord('F'), 0), #Measure 8
                   (120/171, 292, ord('C'), 0),(120/171, 168, ord('N'), 0),(240/171, 230, ord('O'), 0),
                   (120/171, 44, ord('N'), 0),(120/171, 168, ord('C'), 0),(240/171, 106, ord('W'), 0),
                   (120/171, 44, ord('N'), 0),(120/171, 106, ord('C'), 0),(180/171, 230, ord('W'), 0), (60/171, 292, ord('P'), 0),
                   (120/171, 230, ord('O'), 0),(120/171, 168, ord('N'), 0),(240/171, 106, ord('C'), 0),
                   (60/171, 44, ord('F'), 0),(60/171, 106, ord('D'), 0),(60/171, 230, ord('S'), 0), (60/171, 292, ord('F'), 0),
                   (60/171, 44, ord('F'), 0),(60/171, 106, ord('D'), 0),(60/171, 230, ord('S'), 0), (60/171, 292, ord('F'), 0),
                   (60/171, 44, ord('F'), 0),(60/171, 106, ord('D'), 0),(60/171, 230, ord('S'), 0), (60/171, 292, ord('A'), 0),
                   (60/171, 44, ord('S'), 0),(60/171, 106, ord('D'), 0),(60/171, 230, ord('F'), 0), (60/171, 292, ord('G'), 0),
                   (60/171, 44, ord('J'), 0),(60/171, 106, ord('K'), 0),(60/171, 230, ord('L'), 0), (60/171, 292, ord('J'), 0),
                   (60/171, 44, ord('J'), 0),(60/171, 106, ord('K'), 0),(60/171, 230, ord('L'), 0), (60/171, 292, ord('J'), 0),
                   (60/171, 44, ord('J'), 0),(60/171, 106, ord('K'), 0),(60/171, 230, ord('L'), 0), (60/171, 292, ord('L'), 0),
                   (60/171, 44, ord('L'), 0),(60/171, 106, ord('K'), 0),(60/171, 230, ord('J'), 0), (60/171, 292, ord('H'), 0),
                   (60/171, 44, ord('R'), 0),(60/171, 106, ord('E'), 0),(60/171, 230, ord('W'), 0), (60/171, 292, ord('R'), 0),
                   (60/171, 44, ord('R'), 0),(60/171, 106, ord('E'), 0),(60/171, 230, ord('W'), 0), (60/171, 292, ord('R'), 0),
                   (60/171, 44, ord('R'), 0),(60/171, 106, ord('E'), 0),(60/171, 230, ord('W'), 0), (60/171, 292, ord('Q'), 0),
                   (60/171, 44, ord('W'), 0),(60/171, 106, ord('D'), 0),(60/171, 230, ord('R'), 0), (60/171, 292, ord('T'), 0),
                   (60/171, 44, ord('U'), 0),(60/171, 106, ord('I'), 0),(60/171, 230, ord('O'), 0), (60/171, 292, ord('U'), 0),
                   (60/171, 44, ord('U'), 0),(60/171, 106, ord('I'), 0),(60/171, 230, ord('O'), 0), (60/171, 292, ord('U'), 0),
                   (60/171, 44, ord('U'), 0),(60/171, 106, ord('I'), 0),(60/171, 230, ord('O'), 0), (60/171, 292, ord('P'), 0),
                   (60/171, 44, ord('O'), 0),(60/171, 106, ord('I'), 0),(60/171, 230, ord('U'), 0), (60/171, 292, ord('Y'), 0),
                   (60/171, 44, ord('F'), 0),(60/171, 106, ord('D'), 0),(60/171, 230, ord('S'), 0), (60/171, 292, ord('F'), 0),
                   (60/171, 44, ord('F'), 0),(60/171, 106, ord('D'), 0),(60/171, 230, ord('S'), 0), (60/171, 292, ord('F'), 0),
                   (60/171, 44, ord('F'), 0),(60/171, 106, ord('D'), 0),(60/171, 230, ord('S'), 0), (60/171, 292, ord('A'), 0),
                   (60/171, 44, ord('S'), 0),(60/171, 106, ord('D'), 0),(60/171, 230, ord('F'), 0), (60/171, 292, ord('G'), 0),
                   ...
                   (60/171, 44, ord('L'), 0),(30/171, 106, ord('K'), 0),(30/171, 106, ord('K'), 0), (60/171, 230, ord('J'), 0), (60/171, 292, ord('H'), 0),
                   (60/171, 44, ord('L'), 0),(30/171, 106, ord('K'), 0),(30/171, 106, ord('K'), 0), (60/171, 230, ord('J'), 0), (60/171, 292, ord('H'), 0),
                   (60/171, 44, ord('L'), 0),(30/171, 106, ord('K'), 0),(30/171, 106, ord('K'), 0), (60/171, 230, ord('J'), 0), (60/171, 292, ord('H'), 0),
                   (120/171, 44, ord('L'), 0),(120	/171, 106, ord('K'), 0),
                   (60/171, 44, ord('L'), 0),(30/171, 106, ord('K'), 0),(30/171, 106, ord('K'), 0), (60/171, 230, ord('J'), 0), (60/171, 292, ord('H'), 0),
                   (60/171, 44, ord('L'), 0),(30/171, 106, ord('K'), 0),(30/171, 106, ord('K'), 0), (60/171, 230, ord('J'), 0), (60/171, 292, ord('H'), 0),
                   (60/171, 44, ord('L'), 0),(30/171, 106, ord('K'), 0),(30/171, 106, ord('K'), 0), (60/171, 230, ord('J'), 0), (60/171, 292, ord('H'), 0),
                   (120/171, 44, ord('L'), 0),(120	/171, 106, ord('K'), 0),
                   ...
                   (60/171, 44, ord('J'), 0),(60/171, 106, ord('K'), 0),(60/171, 230, ord('L'), 0), (60/171, 292, ord('L'), 0),
                   (60/171, 44, ord('L'), 0),(60/171, 106, ord('K'), 0),(60/171, 230, ord('J'), 0), (60/171, 292, ord('H'), 0),
                   (480/190-0.6, 44, 67, "rest"), (480/190-0.6, 44, 67, "end")
...
songs = {0:[vitality_soundtrack, 150]
        ...
        ,2:[h_a_d_soundtrack, 171]}

song_names = {0:['', "Vitality", "Slow_Vitality", 0.26]
             ,1:['', "P_P", "Slow_P_P",0.5]
             ,2:['', "H_A_D", "Slow_H_A_D", 0.5]}
...
def key_down(key):
    ...
    elif (gamemode == "controls" or gamemode == "game_over" or gamemode == "game_win") and key == 27:
        gamemode = "home"
        home_select = False
        new_game()
...
def draw_win(canvas):
    ...
    hit_percent = int(100*hits/(len(songs[songtrack][0])-3))
    ...
    #Draw the background
    canvas.draw_image(IMG["SONG_WIN"], 
                          [235, 300],
                          IMG_SIZES[IMG["SONG_WIN"]],
                          [235, 300], 
                          [470, 600])
    
    canvas.draw_text(str(song_names[songtrack][difficulty_multiplier]), (270-(frame.get_canvas_textwidth(str(song_names[songtrack][difficulty_multiplier]), 50, 'serif')/2), 190), 50, "red")
    canvas.draw_text(str(points), (255-(frame.get_canvas_textwidth(str(points), 50, "serif")/2), 330), 50, "red")
    canvas.draw_text("x"+str(highest_combo), (360-(frame.get_canvas_textwidth("x"+str(highest_combo), 50, "serif")/2), 495), 50, "red")
    canvas.draw_text(str(hit_percent)+"%", (325-(frame.get_canvas_textwidth(str(hit_percent)+"%", 50, "serif")/2), 410), 50, "red")
    canvas.draw_text(letter[percent], (240-(frame.get_canvas_textwidth(letter[percent], 50, "serif")/2), 255), 50, "red")
...
circle_spec = S_Spectrum(IMG["C_ANIMATION"], [125, 350]) 
#Canvas
